...
WE ALSO HAVE MUMBLE AS A FALLBACK IN CASE OF DISCORD OUTAGES.
...
+ Idling:
Idling in the spawn area is not permitted, Please move to the Armory, VR Room, or AFK Room so that your avatar does not have to be rendered.
...
-Though we'd much prefer you use the Female Crimson Legion Armor.
...
+ Donation of 5k towards the sim tier, For a piece of gear of your choice. (Excluding god favor items at all or uniform pieces in the case that you are in Militia)
...
- Furries or Bronies or Child Avatars (after they give us traffic)
